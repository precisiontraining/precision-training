...
@keyframes glowPulse {
  0%, 100% { opacity: 0.7; transform: translate(-50%, -56%) scale(1); }
  50%       { opacity: 1;   transform: translate(-50%, -56%) scale(1.15); }
}
...
.heroLogo {
  ...
  animation: logoReveal 1.1s cubic-bezier(0.22, 1, 0.36, 1) forwards,
             logoFloat 5s ease-in-out 1.1s infinite;
}
...
.planCard:hover { border-color: rgba(200,169,110,0.3); }
...
.formLinks { display: flex; flex-direction: column; gap: 14px; }
...
.methodSection {
  padding: 100px 0;
  background: linear-gradient(180deg, transparent 0%, rgba(200,169,110,0.03) 40%, transparent 100%);
...
.faqItem:hover { border-color: rgba(200,169,110,0.25); }
...
@media (max-width: 1100px) {
  .methodGrid { grid-template-columns: 1fr 1fr; }
}

@media (max-width: 900px) {
  .cards       { grid-template-columns: 1fr; }
  .whatYouGet  { grid-template-columns: 1fr; }
  .stepsWrap   { grid-template-columns: 1fr; gap: 48px; }
  .methodGrid  { grid-template-columns: 1fr 1fr; }
  .statsBar    { flex-direction: column; }
  .statDivider { width: 80%; height: 1px; }
}

@media (max-width: 640px) {
  .section      { padding: 64px 20px; }
  .sectionInner { padding: 0 20px; }
  .methodSection{ padding: 64px 20px; }
  .heroLogo     { width: 160px; }
  .heroContent  { padding: 100px 20px 80px; }
