...
export default function Home() {
  ...
  const faqs = [
    ...
    {
      q: 'What AI technology powers Precision Training?',
      a: 'Your plan is generated using GPT-4o, one of the most advanced language models available today. The system is custom-built to apply your personal metrics — including Mifflin-St Jeor BMR calculation for precise calorie targets — and output a structured, evidence-based plan. Not generic text.',
    },
    {
    ...
    <div className={styles.page}>
      ...
      <section className={styles.methodSection}>
        <div className={styles.sectionInner}>
          ...
          <h2 className={styles.sectionTitle}>Built on <span className={styles.gold}>proven science.</span></h2>
          <p className={styles.methodIntro}>
            Every plan is calculated using the same principles applied by certified sports coaches and nutritionists —
            automated, precise and delivered within minutes.
          </p>
          <div className={styles.methodGrid}>
            <div className={styles.methodCard}>
              ...
              <p>Generated by one of the world's most capable AI models, fine-tuned to produce structured fitness programming — not generic responses.</p>
            </div>
            <div className={styles.methodCard}>
              <div className={styles.methodIcon}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              ...
              <h3>Evidence-Based Formulas</h3>
              <p>Calorie targets use Mifflin-St Jeor BMR — the gold standard in sports nutrition. Training applies scientifically proven progressive overload principles.</p>
            </div>
            <div className={styles.methodCard}>
              <div className={styles.methodIcon}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
